...
<div class="face-one-intro">
    <div class="face-one-intro-title">face-touch</div>
    ...
    <!-- MARKRUN-HTML
        <div class="face-one-readmedemo">
            <div class="face-one-readmedemo-node">
                <div id="simple-demo" class="face-one-readmedemo-node-render">
                    <div id="box" style="width:100px;height:100px;background-color:skyblue;cursor:pointer;position:relative;z-index:99;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="face-one-intro-tool">
        <a href="https://onface.github.io/touch" class="face-one-intro-btn face-one-intro-btn--primary mr-online-hide" >在线文档</a>
        <!-- MARKRUN-HTML
            <a href="./doc/intro.md" class="face-one-intro-btn face-one-intro-btn--primary">指引</a>
            <a href="http://github.com/onface/touch" class="face-one-intro-btn">GITHUB</a>
        -->
    </div>
</div>
...
<div style="text-align:center;" >
    <a href="https://travis-ci.org/onface/touch" style="text-decoration: none;" >
        <img alt="Build Status" src="https://api.travis-ci.org/onface/touch.svg?branch=master" />
    </a>
    <a href="https://npmjs.org/package/face-touch"  style="text-decoration: none;" >
        <img alt="NPM version" src="https://img.shields.io/npm/v/face-touch.svg?style=flat" />
    </a>
    <a href="https://npmjs.org/package/face-touch"  style="text-decoration: none;" >
        <img alt="NPM downloads" src="https://img.shields.io/npm/dm/face-touch.svg?style=flat" />
    </a>
</div>


<a href="https://saucelabs.com/u/onface-touch" >
    <img alt="Saucelabs Tests" style="display:block;margin-left:auto;margin-right:auto;" src="https://saucelabs.com/browser-matrix/onface-touch.svg" >
</a>
